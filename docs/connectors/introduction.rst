...
Introduction
=================
The *eta_connect.connectors* module is meant to provide a standardized interface for multiple different
...
The *eta_connect* connector format has the advantage that it can be used for many different kinds of protocols
...
Node Typing
---------------
Eta-connect provides a generic type :attr:`Nodes[N]` which can be used to type a sequence or set of nodes. This is useful when
working with multiple nodes and you want to ensure that all nodes are of the same type.

  .. code-block:: python

    from eta_connect.connectors import Node, NodeModbus, NodeOpcUa
...
.. autofunction:: eta_connect.connectors.base_classes::Connection.from_nodes
    :noindex:
...
.. autofunction:: eta_connect.connectors.base_classes::Connection.from_node
    :noindex:
...
.. autofunction:: eta_connect.connectors::EnEffCoConnection.from_ids
    :noindex:
