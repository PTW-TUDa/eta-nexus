...
EmonioConnection
----------------------------------------------------
.. autoclass:: eta_connect.connectors::EmonioConnection
    :members:
    :noindex:
...
.. autoclass:: eta_connect.connectors.emonio::NodeModbusFactory
    :members:
    :noindex:

NodeEmonio
----------------------------------------------------
.. autoclass:: eta_connect.connectors.node::NodeEmonio
    :inherited-members:
...
Example Usage
--------------------------------------
This example demonstrates how to create a :class:`~eta_connect.connectors.live_connect.LiveConnect` from a dictionary to read data from an Emonio device.
...
:class:`~eta_connect.connectors.emonio.EmonioConnection` class.
...
The :class:`~eta_connect.connectors.emonio.NodeModbusFactory` can be used to create modbus nodes directly.
But this is not recommended, as the :class:`~eta_connect.connectors.emonio.EmonioConnection` class is more convenient and has extra error checking.
